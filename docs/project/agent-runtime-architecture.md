...
- `server.js` 启动后异步同步 Claude / Codex / Gemini / Cursor / CodeBuddy / Kiro / Kimi hooks、opencode / OpenClaw plugins 和 Pi extension
...
opencode 是 plugin 形式集成的 agent；OpenClaw 也走 plugin，但 Phase 1 只上报状态。
