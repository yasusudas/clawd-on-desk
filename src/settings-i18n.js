...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      rowTextScaleDesc: "Scale text in bubbles, HUD, dashboard, and settings. The pet itself is not affected.",
    ...
    zh: {
      ...
      rowTextScale: "文字大小",
      rowTextScaleDesc: "缩放气泡、会话 HUD、Dashboard 和设置页的文字。不影响桌宠本体。",
    ...
    "zh-TW": {
      ...
      rowTextScale: "文字大小",
      rowTextScaleDesc: "縮放氣泡、工作階段 HUD、Dashboard 與設定頁的文字。不影響桌寵本體。",
    ...
    ko: {
      ...
      rowTextScale: "텍스트 크기",
      rowTextScaleDesc: "말풍선, 세션 HUD, 대시보드, 설정의 텍스트 크기를 조절합니다. 펫 본체에는 영향을 주지 않습니다.",
    ...
    ja: {
      ...
      rowTextScale: "文字サイズ",
      rowTextScaleDesc: "バブル・セッションHUD・ダッシュボード・設定の文字を拡大縮小します。ペット本体には影響しません。",
