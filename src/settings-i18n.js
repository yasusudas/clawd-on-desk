...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      rowMiniAutoSnap: "Auto-snap to edges",
      rowMiniAutoSnapDesc: "Automatically enter mini mode when dragged to the left or right screen edge",
    ...
    zh: {
      ...
      rowMiniAutoSnap: "边缘自动吸附",
      rowMiniAutoSnapDesc: "拖到屏幕左右边缘时自动进入迷你模式",
    ...
    "zh-TW": {
      ...
      rowMiniAutoSnap: "邊緣自動吸附",
      rowMiniAutoSnapDesc: "拖到螢幕左右邊緣時自動進入迷你模式",
    ...
    ko: {
      ...
      rowMiniAutoSnap: "가장자리 자동 부착",
      rowMiniAutoSnapDesc: "화면 좌우 가장자리로 드래그하면 자동으로 미니 모드로 전환됩니다",
    ...
    ja: {
      ...
      rowMiniAutoSnap: "端への自動スナップ",
      rowMiniAutoSnapDesc: "画面左右の端にドラッグすると自動的にミニモードに入ります",
