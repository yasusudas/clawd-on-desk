...
(function initSettingsI18n(root) {
  const STRINGS = {
    ...
    zh: {
      ...
      themeBadgeCodexPet: "Codex Pet",
      themeBadgeActive: "当前",
      themeActionGroupCodexPets: "Codex Pet 包",
      themeActionGroupUserThemes: "用户主题",
      themeRefreshImportedPets: "刷新 Codex Pet",
      themeImportPetZip: "导入 Codex Pet（.zip）",
      themeOpenCodexPetsFolder: "打开 Codex Pet 文件夹",
      themeImportUserThemeZip: "导入主题（.zip）",
    ...
    ko: {
      ...
      themeBadgeCodexPet: "Codex Pet",
      themeBadgeActive: "활성",
      themeActionGroupCodexPets: "Codex Pet 패키지",
      themeActionGroupUserThemes: "사용자 테마",
      themeRefreshImportedPets: "Codex Pet 새로고침",
      themeImportPetZip: "Codex Pet 가져오기 (.zip)",
      themeOpenCodexPetsFolder: "Codex Pet 폴더 열기",
      themeImportUserThemeZip: "테마 가져오기 (.zip)",
    ...
    ja: {
      ...
      themeActionGroupCodexPets: "Codex Pet パッケージ",
      themeActionGroupUserThemes: "ユーザーテーマ",
      themeRefreshImportedPets: "Codex Pet を更新",
      themeImportPetZip: "Codex Pet をインポート（.zip）",
      themeOpenCodexPetsFolder: "Codex Pet フォルダを開く",
      themeImportUserThemeZip: "テーマをインポート（.zip）",
