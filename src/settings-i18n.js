...
(function initSettingsI18n(root) {
  const STRINGS = {
    ...
    "zh-TW": {
      ...
      doctorPrivacyShort: "複製時會自動遮掉使用者路徑、API key 和 token，再寫進剪貼簿。",
      ...
      shortcutsTitle: "快速鍵",
      shortcutsSubtitle: "設定桌寵顯示或隱藏，以及權限操作的全域快速鍵。留空就解除綁定。",
      ...
      bubblePermissionDesc: "關掉之後審查提示會回到 agent 終端機或 TUI 處理。Plan review 和 AskUserQuestion 還是會顯示，避免 agent 卡住。秒數是選填的，逾時自動關閉，用在 hook 連線卡住、等不到決定的時候（0 = 不自動關閉）。",
