...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      remoteSshSubtitle: "Manage remote AI coding sessions from the installed app. One-click deploy opens the SSH tunnel, then deploys remote hooks. Profiles never store passwords or passphrases.",
      ...
      remoteSshConnect: "Connect Tunnel",
      ...
      remoteSshConnectFailed: "SSH tunnel failed to connect.",
      remoteSshConnectTimeout: "SSH tunnel did not become ready in time.",
      remoteSshConnectAlreadyConnected: "Tunnel already connected",
      remoteSshDeployShort: "One-click Deploy",
      remoteSshDeploy: "Deploy / Repair Remote Hooks",
      ...
      remoteSshStep_connect: "Connect SSH tunnel",
      ...
      remoteSshConnectWarnNoDeploy: "Hooks are not deployed yet. One-click deploy opens the SSH tunnel, deploys hooks from this app, and shows the live log here. Dashboard stays empty until deploy succeeds and the remote agent sends an event.",
    ...
    zh: {
      ...
      remoteSshSubtitle: "从已安装的 Clawd 里管理远程 AI 编码会话。一键部署会先打开 SSH 隧道，再部署远端 hook。Clawd 不存任何密码或私钥口令。",
      remoteSshSectionProfiles: "配置",
      remoteSshAddProfile: "+ 新增配置",
      remoteSshEmpty: "还没有配置。点击\"新增配置\"添加你的第一个远程 SSH 隧道。",
      remoteSshConnect: "连接隧道",
      ...
      remoteSshConnectFailed: "SSH 隧道连接失败。",
      remoteSshConnectTimeout: "SSH 隧道未能及时就绪。",
      remoteSshConnectAlreadyConnected: "隧道已连接",
      remoteSshDeployShort: "一键部署",
      remoteSshDeploy: "部署 / 修复远端 Hook",
      ...
      remoteSshStep_connect: "连接 SSH 隧道",
      ...
      remoteSshConnectWarnNoDeploy: "Hook 文件还没部署。一键部署会打开 SSH 隧道、从当前 Clawd 应用部署 hook，并在这里显示实时日志。Dashboard 要等部署成功且远端 agent 发出事件后才会出现会话。",
    ...
    ko: {
      ...
      remoteSshSubtitle: "설치된 앱에서 원격 AI 코딩 세션을 관리하세요. 원클릭 배포가 SSH 터널을 연 뒤 원격 hooks를 배포합니다. Clawd는 비밀번호나 패스프레이즈를 저장하지 않습니다.",
      remoteSshSectionProfiles: "프로필",
      remoteSshAddProfile: "+ 프로필 추가",
      remoteSshEmpty: "아직 프로필이 없습니다. \"프로필 추가\"를 눌러 첫 원격 SSH 터널을 설정하세요.",
      remoteSshConnect: "터널 연결",
      ...
      remoteSshConnectFailed: "SSH 터널 연결에 실패했습니다.",
      remoteSshConnectTimeout: "SSH 터널이 제때 준비되지 않았습니다.",
      remoteSshConnectAlreadyConnected: "터널이 이미 연결됨",
      remoteSshDeployShort: "원클릭 배포",
      remoteSshDeploy: "원격 Hook 배포 / 복구",
      ...
      remoteSshStep_connect: "SSH 터널 연결",
      ...
      remoteSshConnectWarnNoDeploy: "Hook 파일이 아직 배포되지 않았습니다. 원클릭 배포가 SSH 터널을 열고 이 앱에서 hooks를 배포하며 여기에서 실시간 로그를 보여줍니다. 배포가 성공하고 원격 agent 이벤트가 들어와야 Dashboard에 세션이 표시됩니다.",
    ...
    ja: {
      ...
      remoteSshSubtitle: "インストール済みアプリからリモート AI コーディングセッションを管理します。ワンクリックデプロイで SSH トンネルを開いてからリモート hooks をデプロイします。Clawd はパスワードやパスフレーズを保存しません。",
      ...
      remoteSshConnectFailed: "SSH トンネルの接続に失敗しました。",
      remoteSshConnectTimeout: "SSH トンネルが時間内に準備できませんでした。",
      remoteSshConnectAlreadyConnected: "トンネルは接続済み",
      remoteSshDeployShort: "ワンクリックデプロイ",
      remoteSshDeploy: "リモート Hook デプロイ / 修復",
      ...
      remoteSshStep_connect: "SSH トンネル接続",
      ...
      remoteSshConnectWarnNoDeploy: "Hook ファイルはまだデプロイされていません。ワンクリックデプロイで SSH トンネルを開き、このアプリから hooks をデプロイし、ここにライブログを表示します。デプロイ成功後、リモート agent のイベントが届くまで Dashboard は空のままです。",
